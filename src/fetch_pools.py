...
# # Define the list of large-tokens/stablecoins to exclude by their symbol
# EXCLUDE_SYMBOLS = {"WETH", "WBTC", "BTC", "USDC", "USDT", "crvUSD", "DAI", "thUSD"}

# def filter_out_large_token_pools(pools):
#     filtered_pools = []
#     for pool in pools:
#         token0_symbol = pool["token0"]["symbol"]
#         token1_symbol = pool["token1"]["symbol"]
#         if token0_symbol in EXCLUDE_SYMBOLS or token1_symbol in EXCLUDE_SYMBOLS:
#             continue  # skip pools with excluded tokens
...
#     # # Filter out pools containing large tokens
#     # pools = filter_out_large_token_pools(pools)
#     # print(f"✅ Total pools after filtering large tokens: {len(pools)}")
